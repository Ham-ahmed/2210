...
echo -e "${CYAN}"
echo "################################################################"
echo "#      Start downloading and installing  xstreamity_5.16       #"
echo "#####################################################$$$$$$$####"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/2210/refs/heads/main/enigma2-plugin-extensions-xstreamity_5.16.20251020_all.ipk"
IPK_NAME="eenigma2-plugin-extensions-xstreamity_5.16.20251020_all.ipk"
